...
module "kubernetes_deploy" {
  source = "./modules/kubernetes_deploy"

  deploy_location = "${var.deploy_location}"

  master_endpoint = "${var.kubernetes_master_endpoint != ""? var.kubernetes_master_endpoint : module.gke.master_endpoint}"
  client_certificate = "${var.kubernetes_client_certificate != ""? var.kubernetes_client_certificate : module.gke.client_certificate}"
  client_key = "${var.kubernetes_client_key != ""? var.kubernetes_client_key : module.gke.client_key}"
  cluster_ca_certificate = "${var.kubernetes_cluster_ca_certificate != ""? var.kubernetes_cluster_ca_certificate : module.gke.cluster_ca_certificate}"
}
